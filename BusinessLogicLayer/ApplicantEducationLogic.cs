    ...
    public class ApplicantEducationLogic : BaseLogic<ApplicantEducationPoco>
    {
        ...
        protected override void Verify(ApplicantEducationPoco[] pocos)
        {
            ...
            foreach (var poco in pocos) {
                ...
                {
                    exceptions.Add(new ValidationException(109, $"Completion Date for ApplicationEducation cannot be null or empty"));
                }
                else if (string.IsNullOrEmpty(poco.StartDate.ToString()))
                {
                    exceptions.Add(new ValidationException(109, $"Start Date for ApplicationEducation cannot be null or empty"));
                }
